        ...
        <div class="flex-1 p-8">
            ...
            <div class="bg-white rounded-lg shadow-md mb-6">
                ...
                <form action="../Controllers/add_health_record.php" method="POST" class="py-6 px-8">
                    <!-- Form divided into sections with cards -->
                    <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <select name="blood_type" id="blood_type" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring focus:ring-green-500 focus:ring-opacity-50">
                                            <option value="">Select</option>
